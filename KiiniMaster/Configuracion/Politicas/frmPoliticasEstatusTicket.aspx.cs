    ...
    public partial class frmPoliticasEstatusTicket : System.Web.UI.Page
    {
        ...
        private void CargaCombos()
        {
            try
            {
                ...
                ddlRolSolicita.DataSource = _servicioRoles.ObtenerRoles((int)BusinessVariables.EnumTiposUsuario.Empleado, true).Where(w => rolespermitidos.Contains(w.Id));
                ddlRolSolicita.DataTextField = "Descripcion";
                ddlRolSolicita.DataValueField = "Id";
                ddlRolSolicita.DataBind();

                ddlRolPertenece.DataSource = _servicioRoles.ObtenerRoles((int)BusinessVariables.EnumTiposUsuario.Empleado, true).Where(w => rolespermitidos.Contains(w.Id));
