                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel2" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="2" Enabled="False" />
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel3" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="3" Enabled="False" />
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel4" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="4" Enabled="False" />
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel5" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="5" Enabled="False" />
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel6" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="6" Enabled="False" />
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-offset-1">
                                                        ...
                                                        <asp:Button runat="server" ID="btnAgregarNivel7" Text="Agregar" CssClass="btn btn-primary btn-xs" OnClick="OnClickNivelSubMenu" CommandArgument="7" Enabled="False" />
