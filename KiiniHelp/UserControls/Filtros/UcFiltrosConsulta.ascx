<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UcFiltrosConsulta.ascx.cs" Inherits="KiiniHelp.UserControls.Filtros.UcFiltrosConsulta" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroGrupo.ascx" TagPrefix="uc1" TagName="UcFiltroGrupo" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroOrganizacion.ascx" TagPrefix="uc1" TagName="UcFiltroOrganizacion" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroUbicacion.ascx" TagPrefix="uc1" TagName="UcFiltroUbicacion" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroServicioIncidente.ascx" TagPrefix="uc1" TagName="UcFiltroServicioIncidente" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroTipificacion.ascx" TagPrefix="uc1" TagName="UcFiltroTipificacion" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroPrioridad.ascx" TagPrefix="uc1" TagName="UcFiltroPrioridad" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroEstatus.ascx" TagPrefix="uc1" TagName="UcFiltroEstatus" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroSla.ascx" TagPrefix="uc1" TagName="UcFiltroSla" %>
<%@ Register Src="~/UserControls/Filtros/UcFiltroFechas.ascx" TagPrefix="uc1" TagName="UcFiltroFechas" %>
        ...
        <ContentTemplate>
            <div class="modal-dialog modal-lg">
                <div class="modal-content" style="width: 450px">
                    <uc1:UcFiltroFechas runat="server" ID="ucFiltroFechas" />
                </div>
            </div>
        </ContentTemplate>
    </asp:UpdatePanel>
