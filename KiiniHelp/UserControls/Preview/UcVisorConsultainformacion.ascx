                        ...
                        <asp:Repeater runat="server" ID="rptArchivos">
                            <ItemTemplate>
                                <div class="row">
                                    ...
                                    <asp:HyperLink runat="server" Text="Download" NavigateUrl='<%# ResolveUrl(string.Format("~/Downloads/FrmDownloads.aspx?file={0}", BusinessVariables.Directorios.RepositorioTemporalInformacionConsulta + "~" + Eval("Archivo"))) %>'></asp:HyperLink>
                                    <asp:LinkButton runat="server" Text="Preview" ID="btnPreviewDocument" CssClass="margin-left-5" OnClick="btnPreviewDocument_OnClick" CommandArgument='<%# Eval("Archivo") %>'></asp:LinkButton>
                                </div>
                            </ItemTemplate>
                        </asp:Repeater>
                    </div>
                ...
                <div class="row text-center" runat="server" id="divEvaluacion">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="module-inner">
                            ...
                            <asp:LinkButton runat="server" ID="lbtnLike" OnClick="lbtnLike_OnClick"> <asp:Image runat="server" ID="imgLike" ImageUrl="~/assets/images/like_S1.png"/></asp:LinkButton>
                            <asp:LinkButton runat="server" ID="lbtnNotLike" OnClick="lbtnNotLike_OnClick"> <asp:Image runat="server" ID="imgDontLike" ImageUrl="~/assets/images/dontlike_S1.png"/></asp:LinkButton><br />
