                        ...
                        <div runat="server" id="divStep4Data" visible="false">
                            ...
                            <div class="form-group">
                                <div style="width: 50%; float: left">
                                    <div class="form-group">
                                        Prioridad<br />
                                        <asp:DropDownList runat="server" ID="ddlPrioridad" Width="450px" CssClass="form-control" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlImpacto_OnSelectedIndexChanged" />
                                    </div>
                                    <div class="form-group">
                                        Impacto<br />
                                        <asp:DropDownList runat="server" ID="ddlUrgencia" Width="450px" CssClass="form-control" AutoPostBack="True" AppendDataBoundItems="True" OnSelectedIndexChanged="ddlUrgencia_OnSelectedIndexChanged" />
                                    </div>
                                </div>
                                <div style="width: 50%; float: left">
