                            ...
                            <div id="collapseFiltros" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingFiltros">
                                <div class="panel-body">
                                    <div class="form-horizontal">
                                        <div class="form-group">
                                            <asp:Label class="col-xs-1 control-label" runat="server">Catalogos</asp:Label>
                                            <div class="col-xs-2">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-xs-1">
                                                <asp:Button runat="server" CssClass="btn btn-primary" ID="btnNew" Text="Agregar Catalogo" OnClick="btnNew_OnClick" />
                                            </div>
                                            <div style="width: 45px"></div>
                                            <div class="col-xs-1">
                                                <asp:Button runat="server" CssClass="btn btn-primary" ID="btnCargarCatalogo" Text="Cargar Catalogo" OnClick="btnCargarCatalogo_OnClick" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
