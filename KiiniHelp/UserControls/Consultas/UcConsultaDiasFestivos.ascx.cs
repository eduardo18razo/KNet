...
namespace KiiniHelp.UserControls.Consultas
{
    public partial class UcConsultaDiasFestivos : UserControl
    {
        ...
        private void LlenaFeriadosConsulta()
        {
            try
            {
                rptResultados.DataSource = _servicioDiasFestivos.ObtenerDiasFeriadosConsulta(txtFiltro.Text.Trim());
        ...
        protected void btnDownload_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                List<DiasFeriados> lstcatalogos = _servicioDiasFestivos.ObtenerDiasFeriadosConsulta(filtro);
        ...
        protected void OnCheckedChanged(object sender, EventArgs e)
        {
            try
            {
                _servicioDiasFestivos.Habilitar(int.Parse(((CheckBox)sender).Attributes["data-id"]), ((CheckBox)sender).Checked);
                LlenaFeriadosConsulta();
            }
            catch (Exception ex)
            {
        ...
        protected void btnEditar_OnClick(object sender, EventArgs e)
        {
            try
            {
                ucAltaDiasFestivos.IdDiaFeriado = int.Parse(((LinkButton)sender).CommandArgument);
