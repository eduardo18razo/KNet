            ...
            <div class="panel-body">
                ...
                <div class="form-horizontal">
                    <div class="form-group">
                        <asp:Label runat="server" Text="Grupo Solitante" CssClass="col-sm-2 control-label" />
                        <div class="col-sm-4">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <asp:CheckBoxList runat="server" RepeatDirection="Horizontal" ID="chklbxDias" OnSelectedIndexChanged="chklbxDias_OnSelectedIndexChanged" AutoPostBack="True" />
                        </div>
                    </div>
                    <div class="form-group">
