            ...
            <div class="row">
                <div class="col-lg-12 col-md-12">
                    <div class="module-inner">
                        ...
                        <asp:Button type="button" class="col-lg-2 col-md-2 col-sm-2 btn btn-primary btn-lg" runat="server" Text="Crear ticket" ID="btnCancelar" OnClick="btnCancelar_OnClick" />
                        <asp:Button type="button" class="col-lg-2 col-md-2 col-sm-2 btn btn-primary btn-lg" runat="server" Text="Crear ticket" ID="btnGuardar" OnClick="btnGuardar_OnClick" />
                        <br />
                        <hr />
