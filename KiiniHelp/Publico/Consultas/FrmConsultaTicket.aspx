        ...
        <ContentTemplate>
            <div runat="server" id="divConsulta">
                <div class="project-heading">
                    ...
                    <br>
                    <br>
                    <h3 class="h6"><a href="index.html">Home</a> / <a href="user_select.html">Cliente</a> / Consulta de tickets</h3>
                    <hr>
                </div>
                                        ...
                                        <div class="module-content-inner no-padding-bottom">
                                            <div data-parsley-validate id="" class="form-horizontal">
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <asp:TextBox required runat="server" CssClass="form-control" ID="txtTicket" placeholder="Ingresa aquí" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label" for="">Clave de registro</label>
                                                    <div class="col-sm-10">
                                                        <asp:TextBox required type="text" class="form-control" placeholder="Ingresa aquí" runat="server" ID="txtClave" />
                                                    </div>
                                                </div>
                                                <div class="form-group">
            ...
            <div runat="server" id="divDetalle" visible="True">
                <div class="project-heading">
                    <br>
                    <br>
                    <br>
